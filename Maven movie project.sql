...
SELECT P.CUSTOMER_ID,SUM(AMOUNT) AS SPENDING,C.FIRST_NAME
...
FROM RENTAL 
GROUP BY CUSTOMER_ID
HAVING NUMBER_OF_RENTALS>30) AS MORE_THAN_30);
...
FROM ADVISOR
UNION SELECT FIRST_NAME,LAST_NAME,'STAFF MEMBER' AS DESIGNATION
FROM STAFF);
